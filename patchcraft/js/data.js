  ...
  const carriers = [
    {
      ...
      nameZh: '护照夹',
      description: 'Premium handmade passport holder crafted from top-grain leather. Features two interior card slots and a pen loop. Perfect for personalizing with your favorite patches to make every journey uniquely yours.',
      descriptionZh: '优质手工头层牛皮护照夹，内含两个卡槽和笔环。贴上你喜欢的布贴，让每次旅行都与众不同。',
    ...
    },
    {
      name: 'Pencil Case',
      nameZh: '笔袋',
      description: 'Durable canvas pencil case with a smooth YKK zipper. Spacious enough for all your stationery essentials. Customize it with vibrant patches that show off your personality.',
      descriptionZh: '耐用帆布笔袋，配备顺滑YKK拉链，空间充裕。用缤纷布贴展示你的个性。',
    ...
    },
    {
      name: 'Laptop Sleeve',
      nameZh: '电脑包',
      description: 'Padded laptop sleeve fits 13-14 inch devices snugly. Soft fleece lining protects your laptop from scratches. The large exterior surface is the perfect canvas for your patch art collection.',
      descriptionZh: '加棉笔记本内胆包，适配13-14寸设备，柔软绒布内衬防刮花。超大外表面是布贴创作的完美画布。',
  ...
  const patches = [
    {
      ...
      description: 'Cheerful daisy patch with bright yellow center and crisp white petals. Machine-embroidered on premium felt with iron-on backing.',
      descriptionZh: '明亮的小雏菊布贴，金黄色花芯搭配洁白花瓣，优质毛毡机绣，热熔胶背贴。',
    ...
    {
      name: 'Rose', nameZh: '玫瑰',
      description: 'Elegant layered rose patch in rich crimson. Detailed petal shading with emerald leaves. A timeless floral accent.',
      descriptionZh: '深红色层叠玫瑰布贴，细腻的花瓣渐变与翠绿叶片，永恒的经典花卉装饰。',
    ...
    },
    {
      ...
      description: 'Adorable gray kitten patch with pink nose and curious whiskers. Irresistibly cute on any surface.',
      descriptionZh: '可爱的灰色小猫布贴，粉色鼻头和俏皮胡须，贴在哪里都超萌。',
    ...
    },
    {
      ...
      description: 'Graceful blue butterfly with translucent wings. Brings a sense of freedom and beauty to your creation.',
      descriptionZh: '优雅的蓝色蝴蝶布贴，半透明翅膀效果，为你的作品增添自由与美感。',
    ...
    {
      name: 'Star', nameZh: '星星',
      description: 'Classic golden star patch. Simple yet eye-catching. Perfect filler for any design layout.',
      descriptionZh: '经典金色五角星布贴，简约而醒目，是任何设计排列的完美填充。',
    ...
    },
    {
      ...
      description: 'Sweet red heart patch — the universal symbol of love. Soft edges and vibrant color.',
      descriptionZh: '甜蜜的红色爱心布贴，爱的通用符号，圆润的边缘与鲜艳的色彩。',
    ...
    {
      name: 'Moon', nameZh: '月亮',
      description: 'Dreamy crescent moon in warm gold. Pairs beautifully with stars and nature-themed patches.',
      descriptionZh: '梦幻暖金色弯月布贴，与星星和自然主题布贴搭配绝佳。',
    ...
    },
    {
      ...
      description: 'Vibrant six-color rainbow arch with fluffy cloud accents. Spreads joy and positivity.',
      descriptionZh: '鲜艳的六色彩虹拱桥布贴，搭配蓬松云朵，传递快乐与正能量。',
      image: patchSVG(
    ...
    },
    {
      ...
      description: 'Romantic LOVE text patch in soft rose pink. Bold serif lettering with a hand-written feel.',
      descriptionZh: '浪漫的LOVE字母布贴，柔和玫瑰粉色，粗衬线字体带有手写感。',
    ...
    },
    {
      ...
      description: 'Lush hand-tied bouquet with pink and lavender blooms. Our most popular patch for a romantic touch.',
      descriptionZh: '粉色与薰衣草色花束布贴，我们最受欢迎的浪漫系列款式。',
      image: patchSVG(
